...
function displayEvents(location, page, searchTerm, zipcode, within) {
  ...
  $.ajax({
    url: "http://api.eventful.com/json/events/search?...&app_key=4xmNBd2Pb7vPw3Rz&l=" + location + zipcode + within + searchTerm + "&page_size=20&page_number=" + page + "&date=Future&sort_order=popularity",
